...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Pierce28',
      password: 'oZ53Av_p1qY66so',
      email: 'Petra_Boehm8@yahoo.com',
      name: 'Orlando Wintheiser',
      shippingAddress: [
        {
          _id: false,
          pincode: 'cross-media',
      ...
      userType: 185,
      mobileNo: '(241) 313-5384',
      resetPasswordLink: {},
      loginRetryLimit: 614,
      loginReactiveTime: '2024-03-11T07:37:11.753Z',
      id: '65807697f2dc600f1fe0a800'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Josh_Kuvalis12',
        'password':'cB4OwjKElhckUB3',
        'email':'Danielle34@yahoo.com',
        'name':'Connie Kohler',
        'shippingAddress':[{
          '_id':false,
          'pincode':'Account',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/device/auth/forgot-password')
      .send({ 'email':'Danielle34@yahoo.com', });
