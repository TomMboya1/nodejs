...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Adonis.Skiles',
      password: '_TmJopSSjS7WAeZ',
      email: 'Alba.Spinka@yahoo.com',
      name: 'Raymond Blanda',
      shippingAddress: [
        {
          _id: false,
      ...
      wishlist: [ {
        _id: false,
        productId: 'time-frame' 
      } ],
      userType: 968,
      mobileNo: '(815) 914-0492',
      resetPasswordLink: {},
      loginRetryLimit: 868,
      loginReactiveTime: '2024-02-07T18:22:09.630Z',
      id: '65807697f2dc600f1fe0a794'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Armand35',
        'password':'IixClKRrJYuyjqB',
        'email':'Kelley.Mante@gmail.com',
        'name':'Jeremiah Lemke',
        'shippingAddress':[{
          '_id':false,
          'pincode':'Intelligent',
          'address1':'Infrastructure',
          'address2':'Rapids',
          'landmark':'invoice',
          'city':'Analyst',
          'isDefault':false,
          'state':'National',
          'addressType':'Wisconsin',
          'fullName':'Checking',
          'mobile':215,
          'addressNo':785
        }],
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/admin/auth/forgot-password')
      .send({ 'email':'Kelley.Mante@gmail.com', });
